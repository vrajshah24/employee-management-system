...
class EmployeeListing extends StatefulWidget {
  const EmployeeListing({super.key});

  @override
  State<EmployeeListing> createState() => _EmployeeListingState();
}

class _EmployeeListingState extends State<EmployeeListing> {
  List<Employee> employeeList = [];

  getData() async {
    employeeList = await EmployeeDatabase.fetchAll();
                        ...
                        Navigator.push(context, MaterialPageRoute(
                          builder: (context) {
                            return SingleEmployee(
                                id: employeeList[index].eid as int);
                          },
                        ));
                      },
                      child: Card(
                              ...
                              Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      const Text('Name : '),
                                      Text(employeeList[index].ename.toString())
                                    ],
                                  ),
                                  Row(
                                    children: [
